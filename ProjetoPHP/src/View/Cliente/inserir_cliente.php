  ...
  <body class="container mt-4">
    ...
    <form class="row g-3 mt-3 p-4 border border-light border-2 rounded" action="/cliente/inserir" method="post">
      ...
      <div class="col-4">
          ...
          <input type="text" class="form-control" name="nome" id="nome" placeholder="Fulano">
      </div>

      <div class="col-4">
          <label for="email" class="label-control">Informe o email</label>
          <input type="text" class="form-control" name="email" id="email" placeholder="Fulano@email.com">
      </div>

      <div class="col-4">
          <label for="idade" class="label-control">Informe a idade</label>
          <input type="number" class="form-control" name="idade" id="idade" placeholder="18">
      </div>
