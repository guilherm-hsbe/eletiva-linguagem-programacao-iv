                                ...
                                <form action="resposta.php" method="post"><!--Form {-->
                                    ...
                                    <div class="row mt-3 mb-2">
                                        ...
                                        <?php
                                            ...
                                            $nCheques = $_POST['nCheques'];
                                            for ($i=1; $i<=$nCheques; $i++){
                                        ?>
                                            <div class="col">
                                                <label for="valCheque<?=$i?>" class="label-control">Valor do Cheque <?=$i?></label>
                                                <input type="number" name="valCheque<?=$i?>" id="valCheque<?=$i?>" class="form-control">
                                            </div>
                                        <?php 
                                            }
                                            session_start();
                                            $_SESSION['somaLote'] = $somaLote;
                                            $_SESSION['nCheques'] = $nCheques;
                                        ?>
                                    </div>
                            </div> 
